                        ...
                        <div class="form-group row k-margin-t-20">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <div class="k-avatar k-avatar--outline k-avatar--danger k-avatar--circle" id="form_avatar_div">
                                    <div class="k-avatar__holder" style="background-image: url(/media/users/avatar_defalut.png)" id="divInfoFormAvatar" runat="server"></div>
                                ...
                                <div class="col-md-12 col-lg-5 col-xl-4">
                                    <div class="k-profile__main">
                                        <div class="k-profile__main-pic">
                                            <img src="/media/users/avatar_defalut.png" id="imgDetailsAvatar" runat="server">
